...
const Home = () => {
  return (
    <div className="bg-gray-200 min-h-screen flex flex-col justify-between relative overflow-hidden">
      {/* Mesh blur-2xl */}
  <div className="absolute inset-0 flex justify-center items-center pointer-events-none">
      ...
      <div className="container max-w-6xl mx-auto px-4 py-6">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <span className="hidden sm:flex text-lg sm:text-xl md:text-2xl text-gray-600 font-bold"><h1 className="Montserrat">Medikea</h1> </span>
          </div>
          <div className="flex space-x-4 sm:space-x-6 items-center">
            <a href="#" className="text-base text-gray-600 sm:text-lg font-medium hover:underline">Log in</a>
            <a
              href="#"
      ...
      <div className="flex flex-col items-center justify-center text-center space-y-5 py-10 md:py-16 px-3 relative z-10">
        ...
        <p className="text-white font-normal mx-auto max-w-3xl text-base sm:text-lg md:text-xl">
          Our AI platform provides fast, reliable health information to help you
...
>
  Try Now
      ...
      {/* Footer */}
      <div className="container max-w-6xl mx-auto px-4 mt-12 md:mt-16 py-6">
        <div className="flex justify-between items-center">
          <span className="text-xs sm:text-sm md:text-lg text-gray-500">
            &copy; 2024 Medikea
          </span>
          <span className="text-xs sm:text-sm md:text-lg text-gray-500">
            All rights reserved
